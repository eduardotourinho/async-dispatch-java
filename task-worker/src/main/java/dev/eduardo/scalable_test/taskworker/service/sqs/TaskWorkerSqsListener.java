package dev.eduardo.scalable_test.taskworker.service.sqs;
...
import dev.eduardo.scalable_test.taskworker.service.CalculateInterestService;
import dev.eduardo.scalable_test.taskworker.service.ConvertCurrencyService;
...
public class TaskWorkerSqsListener {
    ...
    private void handleConvertCurrencyTask(ConvertCurrencyMessage taskMessage) {
        log.info("Processing convert currency task: {} with payload: {}", taskMessage.getTaskId(), taskMessage.getPayload());
